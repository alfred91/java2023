...
public class Ejecutable {
	...
	public static void main(String[] args) {
		...
		series.add(new Serie("The Last of us", 1, "Un fulano", Serie.Genero.DRAMA));
		series.add(new Serie("Tokyo Vice", 1, "Otro fulano", Serie.Genero.DRAMA));
		series.add(new Serie("Friends", 7, "Friendzone", Serie.Genero.COMEDIA));
