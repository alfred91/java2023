...
public class Aplicacion {
	...
	public static void main(String[] args) {
		...
		expedienteAlumno ea1 = new expedienteAlumno(Modalidad.GRADOSUPERIOR, "Sonia", "Díaz Pérez",
													Sexo.FEMENINO, 
		...
		expedienteAlumno ea2 = new expedienteAlumno(Modalidad.GRADOSUPERIOR, "Javier", "Santiago Sánchez",
													Sexo.MASCULINO, 
